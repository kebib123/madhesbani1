...
(function ($) {
    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg   id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg"   data-play="playable" class="not-started playable">',
                '<g class="shape" >',
                '<circle class="progress-track" cx="50" cy="50" r="28.45" stroke="#ffffff" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="5"/>',
                '<circle class="precache-bar" cx="50" cy="50" r="28.45" stroke="#ffffff" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="5" transform="rotate(-90 50 50)"/>',
                '<circle class="progress-bar" cx="50" cy="50" r="28.45" stroke="#009EF8" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="5" transform="rotate(-90 50 50)"/>',
                '</g>',
            ...
            $.each(this, function (a, b) {
                ...
                template = template.replace('width=" "','width="'+ audio.data('size')  +'"');
                template = template.replace('height=" "','height="'+ audio.data('size')  +'"');
