...
var Core = function(options) {
 ...
 $('.checkshow').change(function(){
    if($(this).is(":checked"))
    $('.showhideonchecked').fadeIn('slow');
    else
    $('.showhideonchecked').fadeOut('slow');

    });
  


 $('.checkshow1').change(function(){
    if($(this).is(":checked"))
    $('.showhideonchecked1').fadeIn('slow');
    else
    $('.showhideonchecked1').fadeOut('slow');
  ...
  $('.showbtn').click(function(){
    $('.screen-option').toggle("slide", { direction: "up" }, 1);
 });